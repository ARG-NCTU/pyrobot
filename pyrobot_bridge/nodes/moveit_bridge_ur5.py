...
class MoveitInterface(object):
    ...
    def __init__(self):
        ...
        self._traj_action = actionlib.SimpleActionClient("/ur5/execute_trajectory", ExecuteTrajectoryAction)
    ...
    def _init_moveit(self):
        ...
        rd_name = rospy.get_param("pyrobot/ur5/robot_description")

	self.robot = moveit_commander.RobotCommander(rd_name, "ur5")
        self.scene = moveit_commander.PlanningSceneInterface("ur5")
        self.moveit_group = moveit_commander.MoveGroupCommander(mg_name, rd_name, "ur5")
