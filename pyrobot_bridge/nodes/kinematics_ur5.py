...
class Kinematics(object):
    ...
    def _init_kinematics(self):
        ...
        self.arm_joint_names = [u'shoulder_pan_joint', u'shoulder_lift_joint', u'elbow_joint', u'wrist_1_joint', u'wrist_2_joint', u'wrist_3_joint']
        self.arm_link_names = [u'shoulder_link', u'upper_arm_link', u'forearm_link', u'wrist_1_link', u'wrist_3_link', u'wrist_3_link', u'ee_link']
        self.arm_dof = 6
